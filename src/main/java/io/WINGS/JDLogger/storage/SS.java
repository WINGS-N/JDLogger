...
import io.WINGS.providers.chat.Color;
...
public interface SS {
    ...
    //Authors & Plugin data
    String pl = "JDLogger";
    String PluginAuthor = "WINGS I.O.";
    String bug_report = "https://github.com/WINGS-IO/JDLogger/issues";

    //Messages

    //On load MSG
    String LagMeterStart = "Starting LagMeter : Loading components...";
    String LagMeterLowTPSStart = "Starting LagMeter : component : LagDMGevent";
    String LagMeterHighPingStart = "Starting LagMeter : component : io.WINGS.JDLogger.listeners.lags.PingsDMGevent";
    String DeathEventListenerStart = "Starting Death listener : Death";
    String by = "By ";
    ...
    String prefix = ChatColor.BLACK +
            ...
            ChatColor.RESET +
            " ";
    String LagmetrPrefix = Color.translate(config.getString("LagMeter.prefix", defaults.LagMeter_prefix) + " ");

    //LagMeter Messages
    String LowTps = Color.translate(config.getString("LagMeter.TPS.LowTPSMessage", defaults.LagMeter_TPS_LowTPSMessage) + " ");
    String HighPing = Color.translate(config.getString("LagMeter.PING.HighPingMessage", defaults.LagMeter_PING_HighPingMessage) + " ");
    String LowTpsMob = Color.translate(config.getString("LagMeter.TPS.LowTPSEntityDamageMessage", defaults.LagMeter_TPS_LowTPSEntityDamageMessage) + " ");
    String HighPingMob = Color.translate(config.getString("LagMeter.PING.HighPingEntityDamageMessage", defaults.LagMeter_PING_HighPingEntityDamageMessage) + " ");
    String Ping = "PING = %s";
